import pytest
import paibox as pb
from paibox.implement.experimental.coreblock import get_neuron_segments_1, get_neuron_segments_2, NeuronSegment
from paibox.implement.experimental.coreblock import NeuronSegment as NS
...
@pytest.mark.parametrize(
    ...
    [
        (
                [n3, n5], 512,
                [[NS(n5, slice(0, 50, 1), slice(0, 50, 1)), NS(n3, slice(0, 200, 1), slice(50, 250, 1)), ]]
        ),
        (
                [n3, n6], 512,
                [[NS(n3, slice(0, 200, 1), slice(0, 200, 1)), NS(n6, slice(0, 312, 1), slice(200, 512, 1)), ],
        ...
        (
                ...
                [[NS(n1, slice(0, 512, 1), slice(0, 512, 1)), ],
                 [NS(n2, slice(0, 512, 1), slice(0, 512, 1)), ],
                 [NS(n1, slice(512, 600, 1), slice(0, 88, 1)), NS(n2, slice(512, 800, 1), slice(88, 376, 1)), ], ]
        ),
        (
                [n2, n4], 512,
                [[NS(n2, slice(0, 512, 1), slice(0, 512, 1)), ],
                 ...
                 [NS(n4, slice(1024, 1536, 1), slice(0, 512, 1)), ],
                 [NS(n4, slice(1536, 2048, 1), slice(0, 512, 1)), ],
                 [NS(n2, slice(512, 800, 1), slice(0, 288, 1)), NS(n4, slice(2048, 2272, 1), slice(288, 512, 1))],
        ...
        (
                [n1, n6], 512,
                [[NS(n1, slice(0, 512, 1), slice(0, 512, 1)), ],
                 [NS(n1, slice(512, 600, 1), slice(0, 88, 1)), NS(n6, slice(0, 400, 1), slice(88, 488, 1))],
                 ]
        ),
        (
                [n2, n6], 512,
                [[NS(n2, slice(0, 512, 1), slice(0, 512, 1)), ],
                 [NS(n2, slice(512, 800, 1), slice(0, 288, 1)), NS(n6, slice(0, 224, 1), slice(288, 512, 1))],
        ...
        (
                [n3, n8], 512,
                [[NS(n3, slice(0, 200, 1), slice(0, 200, 1)), NS(n8, slice(0, 312, 1), slice(200, 512, 1))], ]
        ),
        (
                [n4, n6, n10], 512,
                [[NS(n4, slice(0, 512, 1), slice(0, 512, 1)), ],
                 ...
                 [NS(n4, slice(1024, 1536, 1), slice(0, 512, 1)), ],
                 [NS(n4, slice(1536, 2048, 1), slice(0, 512, 1)), ],
                 [NS(n10, slice(0, 172, 1), slice(0, 172, 1)), NS(n6, slice(0, 340, 1), slice(172, 512, 1))],
                 [NS(n6, slice(340, 400, 1), slice(0, 60, 1)), NS(n4, slice(2048, 2500, 1), slice(60, 512, 1))]
                 ]
        )
    ],
)
