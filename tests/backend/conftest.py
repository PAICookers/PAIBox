...
class NetForTest5(pb.Network):
    def __init__(self):
        ...
        self.s0 = pb.FullConn(self.n1, self.n2, conn_type=pb.SynConnType.All2All, name="s0")
        self.s1 = pb.FullConn(self.n2, self.n3, conn_type=pb.SynConnType.All2All, name="s1")
        self.s2 = pb.FullConn(self.n3, self.n4, conn_type=pb.SynConnType.All2All, name="s2")
        self.s3 = pb.FullConn(self.n4, self.n5, conn_type=pb.SynConnType.All2All, name="s3")
        self.s4 = pb.FullConn(self.n5, self.n6, conn_type=pb.SynConnType.All2All, name="s4")
        self.s5 = pb.FullConn(self.n1, self.n6, conn_type=pb.SynConnType.All2All, name="s5")
        self.s6 = pb.FullConn(self.n2, self.n5, conn_type=pb.SynConnType.All2All, name="s6")
...
class NetForTest6(pb.Network):
    def __init__(self):
        ...
        self.n3 = pb.TonicSpiking(400, 3, name="n3")
        self.n4 = pb.TonicSpiking(400, 3, name="n4")
        self.s0 = pb.FullConn(self.n1, self.n3, conn_type=pb.SynConnType.All2All, name="s0")
        self.s1 = pb.FullConn(self.n1, self.n4, conn_type=pb.SynConnType.All2All, name="s1")
        self.s2 = pb.FullConn(self.n2, self.n3, conn_type=pb.SynConnType.All2All, name="s2")
        self.s3 = pb.FullConn(self.n2, self.n4, conn_type=pb.SynConnType.All2All, name="s3")
        self.s4 = pb.FullConn(self.n3, self.n4, conn_type=pb.SynConnType.All2All, name="s4")
