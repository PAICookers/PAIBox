...
class TestTransforms:
    ...
    def test_AllToAll_weight_scalar(self, weight):
        ...
        x = gen_random_array((num_in,), np.bool)
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                (3, 4),
                gen_random_array((3,), np.bool),
                gen_random_array((3, 4), np.bool),
            ),
            (
                (10, 20),
                gen_random_array((10,), np.bool),
                gen_random_array((10, 20), np.int8),
            ),
            (
                (20, 10),
                gen_random_array((20,), np.bool),
                gen_random_array((20, 10), np.bool),
            ),
            (
                (2, 2),
                np.array([1, 1], dtype=np.bool),
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (gen_random_array((10,), np.bool), gen_random_array((10, 20), np.int8)),
            (np.ones((20, 10), dtype=np.bool), gen_random_array((20, 10), np.bool)),
            (
                np.array((1, 1), dtype=np.bool),
                np.array([[127, 0], [3, -128]], dtype=np.int8),
            ),
    ...
    @pytest.mark.parametrize(
        ...
        [
            (np.bool, (8,), 16, 8, (3,), (1,), (1,), 2, np.int8),
            (np.bool, (28,), 16, 8, (3,), (1,), (1,), 4, np.bool),
            (np.bool, (28,), 24, 12, (3,), (2,), (2,), 3, np.bool),
            (np.bool, (28,), 24, 12, (5,), (2,), (2,), 6, np.bool),
            (np.bool, (16,), 8, 16, (3,), (2,), (0,), 8, np.bool),
            (np.bool, (28,), 16, 8, (3,), (1,), (0,), 1, np.int8),
            (np.bool, (28,), 24, 12, (3,), (2,), (0,), 1, np.int8),
            (np.bool, (28,), 24, 12, (5,), (2,), (0,), 4, np.int8),
            (np.bool, (16,), 8, 16, (3,), (2,), (0,), 2, np.int8),
            (np.uint8, (8,), 16, 8, (3,), (1,), (1,), 2, np.int8),
            (np.uint8, (28,), 16, 8, (3,), (1,), (1,), 4, np.bool),
            (np.uint8, (28,), 24, 12, (3,), (2,), (2,), 3, np.bool),
            (np.int8, (28,), 24, 12, (5,), (2,), (2,), 3, np.bool),
            (np.int8, (16,), 8, 16, (3,), (2,), (0,), 8, np.bool),
    ...
    @pytest.mark.parametrize(
        "xdtype, in_shape, in_channels, out_channels, ksize, stride, padding, groups, kdtype",
        [
            (np.bool, (28, 28), 16, 8, (3, 3), (1, 1), (1, 1), 2, np.bool),
            (np.bool, (28, 28), 24, 12, (3, 3), (2, 2), (2, 1), 3, np.bool),
            (np.bool, (28, 28), 16, 8, (3, 3), (1, 1), (2, 3), 8, np.bool),
            (np.bool, (28, 28), 24, 12, (3, 3), (2, 2), (0, 0), 1, np.int8),
            (np.bool, (28, 28), 24, 12, (5, 5), (2, 1), (0, 0), 4, np.int8),
            (np.bool, (8, 8), 8, 16, (3, 3), (2, 2), (1, 1), 1, np.int8),
            (np.uint8, (28, 28), 16, 8, (3, 3), (1, 1), (1, 1), 8, np.bool),
            (np.uint8, (28, 28), 24, 12, (3, 3), (2, 2), (2, 1), 1, np.bool),
            (np.int8, (28, 28), 16, 8, (3, 3), (1, 1), (2, 3), 4, np.bool),
    ...
    @pytest.mark.parametrize(
        ...
        [
            (np.bool, (28,), 16, 8, (3,), (1,), (0,), (0,), np.bool),
            (np.bool, (28,), 24, 12, (3,), (2,), (2,), (2,), np.bool),
            (np.bool, (28,), 24, 12, (5,), (2,), (0,), (1,), np.bool),
            (np.bool, (16,), 8, 16, (3,), (2,), (1,), (0,), np.bool),
            (np.bool, (28,), 16, 8, (3,), (3,), (0,), (0,), np.int8),
            (np.bool, (28,), 24, 12, (3,), (2,), (3,), (0,), np.int8),
            (np.bool, (28,), 24, 12, (5,), (2,), (0,), (0,), np.int8),
            (np.bool, (16,), 8, 16, (3,), (2,), (1,), (1,), np.int8),
            (np.uint8, (28,), 16, 8, (3,), (1,), (0,), (0,), np.bool),
            (np.uint8, (28,), 24, 12, (3,), (2,), (2,), (2,), np.bool),
            (np.uint8, (28,), 24, 12, (5,), (2,), (0,), (1,), np.bool),
            (np.uint8, (16,), 8, 16, (3,), (2,), (1,), (0,), np.bool),
    ...
    @pytest.mark.parametrize(
        "xdtype, in_shape, in_channels, out_channels, ksize, stride, padding, output_padding, kdtype",
        [
            (np.bool, (12, 12), 16, 8, (3, 3), (1, 1), (1, 1), (1, 1), np.bool),
            (np.bool, (12, 12), 24, 12, (3, 3), (2, 2), (2, 2), (1, 0), np.bool),
            (np.bool, (12, 12), 16, 8, (3, 3), (1, 1), (0, 0), (0, 0), np.bool),
            (np.bool, (12, 12), 24, 12, (3, 3), (2, 2), (1, 2), (0, 1), np.int8),
            (np.bool, (10, 10), 24, 12, (5, 5), (2, 1), (1, 1), (2, 2), np.int8),
            (np.bool, (16, 16), 8, 16, (3, 3), (2, 2), (1, 3), (2, 0), np.int8),
            (np.uint8, (12, 12), 16, 8, (3, 3), (1, 1), (1, 1), (1, 1), np.bool),
            (np.uint8, (12, 12), 24, 12, (3, 3), (2, 2), (2, 2), (1, 0), np.bool),
            (np.int8, (12, 12), 16, 8, (3, 3), (1, 1), (0, 0), (0, 0), np.bool),
            ...
            # ((28, 28), 16, 8, (3, 3), (1, 1), (0, 0), "HWC", np.bool),
            # ((24, 32), 8, 8, (3, 4), (2, 1), (0, 0), "HWC", np.bool),
            # ((24, 24), 8, 16, (7, 7), (2, 2), (0, 0), "HWC", np.bool),
