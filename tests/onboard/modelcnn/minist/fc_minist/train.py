...
def get_args() -> argparse.Namespace:
    """解析命令行参数。"""
    parser = argparse.ArgumentParser(description="MNIST FC 三层网络训练")
...
def build_dataloaders(
    ...
    """
    # MNIST 图像单通道，这里只做 ToTensor 以及标准归一化
...
def main() -> None:
    ...
    model = MNIST_FC(num_classes=10, dropout_p=args.dropout).to(device)
    print(
