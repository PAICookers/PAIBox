...
from simples_quantize.quantize_tools import (  # noqa: E402
...
from simples_quantize.res_cifar10.model import ResNetCIFAR10  # noqa: E402


DEFAULT_DATA_DIR = REPO_ROOT / "simples_quantize" / "data"
DEFAULT_CKPT = BASE_DIR / "checkpoints" / "best_model.pth"
DEFAULT_OUTPUT_DIR = BASE_DIR / "outputs_paiir_backendv2"
...
def main() -> None:
    ...
    export_quantized_model_summary(
        quantized_model,
        output_dir / "quantized_model_layers.json",
        output_dir / "quantized_model_graph.txt",
    )
