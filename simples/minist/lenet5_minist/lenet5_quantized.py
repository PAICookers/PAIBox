...
from simples.minist.lenet5_minist.model import LeNet5
...
SOURCE_CKPT = os.path.join(
    REPO_ROOT, "minist", "lenet5_minist", "checkpoints", "best_model.pth"
)
