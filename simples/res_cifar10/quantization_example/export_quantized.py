"""
ResNetCIFAR10 CIFAR-10 量化工作文档示例。
...
SOURCE_CKPT = os.path.join(REPO_ROOT, "simples", "res_cifar10", "checkpoints", "best_model.pth")
...
def main() -> None:
    ...
    print("=== ResNetCIFAR10 FX 量化并导出 pth ===")
    ...
    print("[5.5] 测试量化前后精度对比 (CIFAR-10测试集验证可能有一定耗时，请等待...)")
