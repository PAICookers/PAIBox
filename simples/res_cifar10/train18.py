from model18 import ResNet18CIFAR10
...
def get_args():
    parser = argparse.ArgumentParser(description="CIFAR-10 ResNet18 训练")
...
def train():
    ...
    best_val_acc = 0.0
    # 注意这里保存为 best_model18.pth
    best_ckpt_path = os.path.join(CKPT_DIR, "best_model18.pth")
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        #         "val_acc": val_acc,
        #     },
        #     os.path.join(CKPT_DIR, f"model18_epoch_{epoch:03d}.pth"),
        # )
