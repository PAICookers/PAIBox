...
def _make_conv2d_like(
    module: ManualConv2d | ManualConvReLU2d | ManualConvAddReLU2d,
) -> nn.Conv2d:
...
class DeployConvAddReLU2d(nn.Module):
    ...
    def __init__(self, manual_module: ManualConvAddReLU2d) -> None:
        super().__init__()
        self.conv = _make_conv2d_like(manual_module)
